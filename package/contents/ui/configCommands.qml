...
Item {
        ...
        ScrollView {
            ...
            ListView {
                ...
                delegate: Kirigami.AbstractCard {
                    width: commandListView.width - Kirigami.Units.smallSpacing * 2
    ...
    Dialog {
        ...
        anchors.centerIn: parent
        width: Math.min(450, commandsRootItem.width * 0.9)
